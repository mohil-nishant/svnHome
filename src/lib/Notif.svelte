<div class="max-w-screen-md sm:mx-auto p-6 bg-neutral-50 shadow-lg rounded-lg mt-3 mx-2">
    ...
    <ul class="divide-y divide-gray-200">
      ...
      <li class="py-2">
        <div class="flex flex-col md:flex-row md:justify-between items-start md:items-center">
          <div class="mb-2 md:mb-0">
            <h3 class="text-lg font-semibold text-indigo-600">Important Update</h3>
      ...
      <li class="py-2">
        <div class="flex flex-col md:flex-row md:justify-between items-start md:items-center">
          <div class="mb-2 md:mb-0">
            <h3 class="text-lg font-semibold text-indigo-600">Back-to-School Event</h3>
